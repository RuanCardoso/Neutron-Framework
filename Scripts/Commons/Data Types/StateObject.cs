...
namespace NeutronNetwork.Internal
{
    public class StateObject
    {
        ...
        public byte[] ReceivedDatagram { get; set; }
        public byte[] SendDatagram { get; set; }
        public IPEndPoint TcpRemoteEndPoint { get; set; }
        public IPEndPoint UdpLocalEndPoint { get; set; }
        ...
        //***************************************************************************
        public Task<int> SendAsyncBytes { get; set; }
        public Task<bool> ReadAsyncBytes { get; set; }
