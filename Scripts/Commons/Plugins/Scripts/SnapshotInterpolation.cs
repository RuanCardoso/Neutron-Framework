...
namespace NeutronNetwork
{
    public static class SnapshotInterpolation
    {
        ...
        public static bool InsertIfNewEnough<T>(T snapshot, SortedList<double, T> buffer)
            where T : ISnapshot
        {
                ...
                where T : ISnapshot
        {
            ...
            double t = InverseLerp(first.remoteTimestamp, second.remoteTimestamp, first.remoteTimestamp + interpolationTime);
