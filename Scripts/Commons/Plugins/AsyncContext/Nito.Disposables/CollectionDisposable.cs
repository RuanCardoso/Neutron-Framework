...
namespace Nito.Disposables
{
    ...
    /// </summary>
    public sealed class CollectionDisposable : SingleDisposable<Queue<IDisposable>>
    {
        /// <summary>
        ...
        public CollectionDisposable(IEnumerable<IDisposable> disposables)
            : base(new Queue<IDisposable>(disposables.WhereNotNull()))
        {
        }
        ...
        public void Add(IDisposable disposable)
        {
            if (disposable == null)
                return;
            if (TryUpdateContext(x => x.Enqueue<IDisposable>(disposable)))
                return;
