...
{
    public static void CreateContainer(string containerName, Player ownerNetworkObjects = null, bool enablePhysics = false, GameObject[] sceneObjects = null, LocalPhysicsMode localPhysicsMode = LocalPhysicsMode.None)
    {
        ...
        if (enablePhysics)
        {
            ...
            Simulate l_Simulate = l_SimulateObject.AddComponent<Simulate>();
